-- Ported from Kong/lua-resty-websocket-proxy (https://github.com/Kong/lua-resty-websocket-proxy).
--
...
--
-- The full text of the License is also available at LICENSE-APACHE in the
-- root of this repository. Unlike the rest of this repository (licensed
-- under the 2-clause BSD license, see README.markdown), this file and its
-- accompanying tests remain under the Apache License, Version 2.0.
